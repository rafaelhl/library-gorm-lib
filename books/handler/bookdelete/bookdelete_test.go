...
import (
	...
	"github.com/rafaelhl/library-gorm-lib/books/handler/bookdelete"
	"github.com/rafaelhl/library-gorm-lib/books/handler/bookdelete/mocks"
)

func TestHandler_ServeHTTP(t *testing.T) {
	deleter := new(mocks.BookDeleter)
	deleter.On("DeleteBook", mock.Anything, uint(1)).Return(nil)
